...
class Ui_AttendanceDialog(object):
    def setupUi(self, AttendanceDialog, listValues):
        ...
        self.txtAttendanceID.setEnabled(False)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
...
#####################     End UI Generation     #####################
    ...
    def setValues(self):
        ...
        self.txtAttendanceID.setText(self.listValues[0])
        self.txtStudentID.setText(self.listValues[1])
        self.txtClassID.setText(self.listValues[2])
        self.cmbPresent.setCurrentText(self.listValues[3])
        self.dateAttendance.setDate(self.listValues[4])

    def getValues(self):
        listResult = []
        listResult.append(self.txtAttendanceID.text())
        listResult.append(self.txtStudentID.text())
        listResult.append(self.txtClassID.text())
        listResult.append(self.cmbPresent.currentText())
        listResult.append(self.dateAttendance.date())
...
if __name__ == "__main__":
    ...
    ui.setupUi(AttendanceDialog, None)
